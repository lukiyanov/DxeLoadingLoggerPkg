# This file was automatically generated with update_edk2_guids.py script [by uefi_retool]
edk2_guids = {
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\AppPkg\AppPkg.dec file
	'gAppPkgTokenSpaceGuid' : [ 0xe7e1efa6, 0x7607, 0x4a78, 0xa7, 0xdd, 0x43, 0xe4, 0xbd, 0x72, 0xc0, 0x99 ],
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\ArmPkg\ArmPkg.dec file
	'gArmTokenSpaceGuid' : [ 0xBB11ECFE, 0x820F, 0x4968, 0xBB, 0xA6, 0xF7, 0x6A, 0xFE, 0x30, 0x25, 0x96 ],
	'gArmMpCoreInfoGuid' : [ 0xa4ee0728, 0xe5d7, 0x4ac5,0xb2, 0x1e, 0x65, 0x8e, 0xd8, 0x57, 0xe8, 0x34],
	'gArmMpCoreInfoPpiGuid' : [ 0x6847cc74, 0xe9ec, 0x4f8f,0xa2, 0x9d, 0xab, 0x44, 0xe7, 0x54, 0xa8, 0xfc],
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\ArmPlatformPkg\ArmPlatformPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\ArmVirtPkg\ArmVirtPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\BeagleBoardPkg\BeagleBoardPkg.dec file
	'gBeagleBoardTokenSpaceGuid' :  [ 0x6834fe45, 0x4aee, 0x4fc6, 0xbc, 0xb5, 0xff, 0x45, 0xb7, 0xa8, 0x71, 0xe2 ],
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\CorebootModulePkg\CorebootModulePkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\CorebootPayloadPkg\CorebootPayloadPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\CryptoPkg\CryptoPkg.dec file
	'gEfiRuntimeCryptProtocolGuid' : [ 0xe1475e0c, 0x1746, 0x4802,0x86, 0x2e, 0x1, 0x1c, 0x2c, 0x2d, 0x9d, 0x86 ],
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\DuetPkg\DuetPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\EdkCompatibilityPkg\EdkCompatibilityPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\EdkShellBinPkg\EdkShellBinPkg.dec file
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\EmbeddedPkg\EmbeddedPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\EmulatorPkg\EmulatorPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\FatBinPkg\FatBinPkg.dec file
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\FatPkg\FatPkg.dec file
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\FmpDevicePkg\FmpDevicePkg.dec file
	'gFmpDevicePkgTokenSpaceGuid' : [ 0x40b2d964, 0xfe11, 0x40dc, 0x82, 0x83, 0x2e, 0xfb, 0xda, 0x29, 0x53, 0x56 ],
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\IntelFrameworkModulePkg\IntelFrameworkModulePkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\IntelFrameworkPkg\IntelFrameworkPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\IntelFsp2Pkg\IntelFsp2Pkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\IntelFsp2WrapperPkg\IntelFsp2WrapperPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\IntelFspPkg\IntelFspPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\IntelFspWrapperPkg\IntelFspWrapperPkg.dec file
	...
	'gTopOfTemporaryRamPpiGuid' : [ 0x2f3962b2, 0x57c5, 0x44ec, 0x9e, 0xfc, 0xa6, 0x9f, 0xd3, 0x02, 0x03, 0x2b ],
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\IntelSiliconPkg\IntelSiliconPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\MdeModulePkg\MdeModulePkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\MdePkg\MdePkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\NetworkPkg\NetworkPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\Nt32Pkg\Nt32Pkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\Omap35xxPkg\Omap35xxPkg.dec file
	'gOmap35xxTokenSpaceGuid' :  [ 0x24b09abe, 0x4e47, 0x481c, 0xa9, 0xad, 0xce, 0xf1, 0x2c, 0x39, 0x23, 0x27],
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\OptionRomPkg\OptionRomPkg.dec file
	'gOptionRomPkgTokenSpaceGuid' : [ 0x1e43298f, 0x3478, 0x41a7, 0xb5, 0x77, 0x86, 0x6, 0x46, 0x35, 0xc7, 0x28 ],
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\OvmfPkg\OvmfPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\PcAtChipsetPkg\PcAtChipsetPkg.dec file
	'gPcAtChipsetPkgTokenSpaceGuid' : [ 0x326ae723, 0xae32, 0x4589, 0x98, 0xb8, 0xca, 0xc2, 0x3c, 0xdc, 0xc1, 0xb1 ],
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\QuarkPlatformPkg\QuarkPlatformPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\QuarkSocPkg\QuarkSocPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\SecurityPkg\SecurityPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\ShellBinPkg\ShellBinPkg.dec file
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\ShellPkg\ShellPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\SignedCapsulePkg\SignedCapsulePkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\SourceLevelDebugPkg\SourceLevelDebugPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\StdLib\StdLib.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\StdLibPrivateInternalFiles\DoNotUse.dec file
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\UefiCpuPkg\UefiCpuPkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\Vlv2DeviceRefCodePkg\Vlv2DeviceRefCodePkg.dec file
	...
	# Guids from C' :\some_dir_1\pci-express-uefi\sources\edk2\Vlv2TbltDevicePkg\PlatformPkg.dec file
